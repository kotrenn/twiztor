...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Interceptor: {
      ...
      "%": "Blob|CanvasGradient|CanvasPattern|CanvasRenderingContext2D|DOMError|File|FileError|MediaError|MediaKeyError|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList|SVGAnimatedString"
    },
    JSBool: {
      "^": "Interceptor;",
    ...
    main: [function() {
      ...
      J.focus$0$x(canvas);
      P.scheduleMicrotask(new D.GameHost(canvas, D.Keyboard$(), 0, 400, 300).get$run());
    }, "call$0", "game__main$closure", 0, 0, 1],
    Keyboard: {
      "^": "Object;_keys",
      Keyboard$0: function() {
        var t1 = W.KeyboardEvent;
        W._EventStreamSubscription$(window, "keydown", new D.Keyboard_closure(this), false, t1);
        W._EventStreamSubscription$(window, "keyup", new D.Keyboard_closure0(this), false, t1);
      },
      static: {
        Keyboard$: function() {
          var t1 = new D.Keyboard(P.HashSet_HashSet(null, null, null, P.int));
          t1.Keyboard$0();
          return t1;
        }
      }
    ...
    Keyboard_closure: {
      "^": "Closure:5;$this",
      call$1: function(e) {
        this.$this._keys.add$1(0, J.get$keyCode$x(e));
      }
    },
    Keyboard_closure0: {
      "^": "Closure:5;$this",
      call$1: function(e) {
        this.$this._keys.remove$1(0, J.get$keyCode$x(e));
      }
    },
    GameHost: {
      "^": "Object;_canvas,_keyboard,_lastTimestamp,_x,_y",
      run$0: [function() {
        var t1 = window;
        C.Window_methods._ensureRequestAnimationFrame$0(t1);
        C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(this.get$_gameLoop()));
      }, "call$0", "get$run", 0, 0, 0],
      _gameLoop$1: [function(_) {
        var t1, t2, elapsed, context;
        t1 = Date.now();
        t2 = this._lastTimestamp;
        elapsed = t2 !== 0 ? (t1 - t2) / 1000 : 0;
        this._lastTimestamp = t1;
        t1 = this._keyboard._keys;
        if (t1.contains$1(0, 38))
          this._y = this._y - 100 * elapsed;
        if (t1.contains$1(0, 40))
          this._y = this._y + 100 * elapsed;
        if (t1.contains$1(0, 37))
          this._x = this._x - 100 * elapsed;
        if (t1.contains$1(0, 39))
          this._x = this._x + 100 * elapsed;
        ...
        context.arc(this._x, this._y, 32, 0, 6.283185307179586, false);
        context.fill("nonzero");
        t1 = window;
        C.Window_methods._ensureRequestAnimationFrame$0(t1);
        C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(this.get$_gameLoop()));
      }, "call$1", "get$_gameLoop", 2, 0, 13]
    }
  }, 1]];
  setupProgram(dart, 0);
...
;
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, v: true}, {func: 1, args: [,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, args: [W.KeyboardEvent]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, v: true, args: [P.double]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(D.game__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(D.game__main$closure(), a);
